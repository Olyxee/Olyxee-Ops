...
export type Task={id:string;code?:string;title:string;project:string;githubUrl?:string;department?:string;createdBy?:string;creatorName?:string;status:Status;assignee?:string;priority:"Critical"|"High"|"Medium"|"Low";createdDate?:string;startDate?:string;due:string;targetWeek?:string;description:string;criteria:string[];dependencies?:string[];comments?:Comment[];activity?:string[];reviewState?:"Not submitted"|"Awaiting review"|"Changes requested"|"Approved";attachments?:string[];pr?:string;blocker?:Blocker;blockerReason?:string;weeklyCommitment?:boolean;available?:boolean;merged?:boolean;submittedAt?:string;completedAt?:string;checklist?:TaskChecklistItem[];updates?:TaskUpdate[];evidence?:TaskEvidence[];activityLog?:TaskActivity[]};
